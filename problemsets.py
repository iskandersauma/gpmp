...
def states(problemset):
  ...
  if problemset == 'robot':
    ...
    start[0] = [  1.0,   0.01,  -1.15, 1.30, 0.0]
    start[1] = [  1.0,   0.01,  -1.15, 1.30, 0.0]
    start[2] = [  1.05,   0.01,  -1.40, 1.30, 0.0]
    start[3] = [  1.05,   0.01,  -1.40, 1.30, 0.0]
    start[4] = [  1.05,   0.01,  -1.40, 1.30, 0.0]
    end[0]   = [  1.6,  0.01,  0.0, 1.25, 1.90]
    end[1]   = [  1.8,  0.01,  0.0, 1.25, 2.00]
    end[2]   = [  1.7,  0.01,  0.0, 1.25, 1.75]
    end[3]   = [  1.5,  0.01,  0.0, 1.25, 1.75]
    end[4]   = [  1.5,  0.01,  0.0, 1.25, 1.75]
    return starts, ends, start, end
  else:
    print "Unknown problem set"
    sys.exit()
